...
import com.gmail.merikbest.ecommerce.dto.auth.AuthenticationRequest;
import com.gmail.merikbest.ecommerce.dto.auth.AuthenticationResponse;
...
public class AuthenticationMapper {
    ...
    public String activateUser(String code) { return authenticationService.activateUser(code);}

    public String sendPasswordResetCode(String email)  {return authenticationService.sendPasswordResetCode(email);}
