package com.gmail.merikbest.ecommerce.service.Impl;

import com.gmail.merikbest.ecommerce.domain.User;
import com.gmail.merikbest.ecommerce.dto.CaptchaResponse;
import com.gmail.merikbest.ecommerce.enums.AuthProvider;
import com.gmail.merikbest.ecommerce.enums.Role;
import com.gmail.merikbest.ecommerce.exception.ApiRequestException;
import com.gmail.merikbest.ecommerce.exception.EmailException;
import com.gmail.merikbest.ecommerce.exception.PasswordConfirmationException;
import com.gmail.merikbest.ecommerce.exception.PasswordException;
import com.gmail.merikbest.ecommerce.repository.UserRepository;
import com.gmail.merikbest.ecommerce.security.JwtProvider;
import com.gmail.merikbest.ecommerce.security.oauth2.OAuth2UserInfo;
import com.gmail.merikbest.ecommerce.service.AuthenticationService;
import com.gmail.merikbest.ecommerce.service.email.MailSender;
...
public class AuthenticationServiceImpl implements AuthenticationService {
    ...
    public String registerUser(User user, String captcha, String password2)  {
        ...
        if (user.getPassword() != null && !user.getPassword().equals(password2)) {
            throw new PasswordException(PASSWORD_DO_NOT_MATCH);
        }
