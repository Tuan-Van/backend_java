package com.gmail.merikbest.ecommerce.service.graphql;
    ...
    private RuntimeWiring buildRuntimeWiring() {
        return RuntimeWiring.newRuntimeWiring()
                .type("Query", typeWiring -> typeWiring
                        ...
                        .dataFetcher("orders", orderService.getAllOrderByQuery())
                        .dataFetcher("ordersByEmail", orderService.getUerOrderByEmailQuery())
                        .dataFetcher("users", userService.getAllUserByQuery())
