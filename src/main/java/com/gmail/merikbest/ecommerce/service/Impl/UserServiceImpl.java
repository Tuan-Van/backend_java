...
import com.gmail.merikbest.ecommerce.repository.PerfumeRepository;
import com.gmail.merikbest.ecommerce.repository.UserRepository;
import com.gmail.merikbest.ecommerce.service.UserService;
...
public class UserServiceImpl implements UserService {
    ...
    @Override
    public Page<User> getAllUsers(Pageable pageable) { return userRepository.findAllByOrderByIdAsc(pageable);}

    @Override
    public List<Perfume> getCart(List<Long> perfumeIds){ return perfumeRepository.findByIdIn(perfumeIds);}
    ...
    @Override
    public DataFetcher<List<User>> getAllUserByQuery() {
