...
import com.gmail.merikbest.ecommerce.security.oauth2.*;
...
import static com.gmail.merikbest.ecommerce.util.TestConstants.*;
...
public class AuthenticationServiceImplTest {
    ...
    @Test
    public void registerUser() throws MessagingException {
        User user = new User();
        user.setFirstName(FIRST_NAME);
        user.setEmail(USER_EMAIL);
    ...
    public void registerGoogleOauthUser() {
        ...
        OAuth2UserInfo google = OAuth2UserFactory.getOAuthUserInfo("google", attributes);
    ...
    public void registerFacebookOauthUser() {
        ...
        OAuth2UserInfo facebook = OAuth2UserFactory.getOAuthUserInfo("facebook", attributes);
    ...
    public void registerGithubOauthUser() {
        ...
        OAuth2UserInfo github = OAuth2UserFactory.getOAuthUserInfo("github", attributes);
    ...
    @Test
    public void sendPasswordResetCode() throws MessagingException {
        User user = new User();
        user.setEmail(USER_EMAIL);
        user.setPasswordResetCode(USER_PASSWORD_RESET_CODE);
